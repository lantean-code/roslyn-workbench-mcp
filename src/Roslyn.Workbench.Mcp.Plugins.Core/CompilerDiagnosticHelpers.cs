...
internal static class CompilerDiagnosticHelpers
{
    ...
    public static async ValueTask<IReadOnlyList<Diagnostic>> GetCompilerDiagnosticsAsync(IReadOnlyList<Document> selectedDocuments, CancellationToken cancellationToken)
    {
