...
/// <summary>
/// Creates code-action runtimes for host composition and tests.
/// </summary>
public static class CodeActionRuntimeFactory
{
    /// <summary>
    /// Creates a new code-action runtime from the provided options.
    /// </summary>
    /// <param name="options">The runtime options.</param>
    /// <returns>The created runtime.</returns>
    public static CodeActionRuntime Create(CodeActionRuntimeOptions options)
    {
