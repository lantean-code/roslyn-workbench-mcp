...
public sealed class CodeActionMutationMcpServerToolTests : IDisposable
{
        ...
        string outcomeName)
    {
        ...
        ToolExecutionContextMockHelper.ConfigureCodeActionContext(context, _roslynWorkspace.CurrentSolution);
