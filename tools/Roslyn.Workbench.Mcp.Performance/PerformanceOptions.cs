...
internal sealed class PerformanceOptions
{
    ...
    public static PerformanceOptions Parse(IReadOnlyList<string> arguments)
    {
        ...
        {
            return new PerformanceOptions { Command = PerformanceCommand.Help };
        }
    ...
    private static PerformanceCommand ParseCommand(string value)
    {
        ...
        {
            return PerformanceCommand.Profile;
        }
