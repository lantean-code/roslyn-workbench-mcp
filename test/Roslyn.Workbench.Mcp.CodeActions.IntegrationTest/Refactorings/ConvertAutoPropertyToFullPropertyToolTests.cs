...
public sealed class ConvertAutoPropertyToFullPropertyToolIntegrationTests
{
    [Fact]
    public async Task GIVEN_ActiveTransaction_WHEN_ExecutingTool_THEN_ShouldStageMutation()
    {
        ...
        var result = await BundledCoreToolTestHarness.ExecuteMutationAsync(coordinator, "convert-auto-property-to-full-property", target, new ConvertAutoPropertyToFullPropertyRequest
        {
            Selection = fixture.GetLocation("Goo"),
        ...
        result.StagedResult.Data!.Operation.Should().Be("convert-auto-property-to-full-property");
