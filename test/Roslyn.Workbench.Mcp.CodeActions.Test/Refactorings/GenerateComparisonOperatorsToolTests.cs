...
public sealed class GenerateComparisonOperatorsToolTests
{
    [Fact]
    public async Task GIVEN_LocationRequest_WHEN_CallingExecuteAsync_THEN_ShouldStageComparisonOperatorAction()
    {
        ...
        var target = new GenerateComparisonOperatorsTool(selectionStager.Object);
