...
internal sealed class IntroduceVariableTool : CodeActionMutationToolHandler<IntroduceVariableRequest>
{
    ...
    protected override ValueTask<PluginExecutionResult<MutationProposal>> ExecuteCoreAsync(IntroduceVariableRequest request, ICodeActionMutationContext context, CancellationToken cancellationToken)
    {
