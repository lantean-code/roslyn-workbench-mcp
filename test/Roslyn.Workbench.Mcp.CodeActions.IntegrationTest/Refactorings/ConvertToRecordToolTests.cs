...
public sealed class ConvertToRecordToolIntegrationTests
{
    [Fact]
    public async Task GIVEN_ActiveTransaction_WHEN_ExecutingTool_THEN_ShouldStageMutation()
    {
        ...
        var result = await BundledCoreToolTestHarness.ExecuteMutationAsync(coordinator, "convert-to-record", target, RefactoringRequestFactory.CreateLocationRequest(fixture.GetLocation("ConvertibleToRecord"), openResult));
        ...
        result.StagedResult.Data!.Operation.Should().Be("convert-to-record");
