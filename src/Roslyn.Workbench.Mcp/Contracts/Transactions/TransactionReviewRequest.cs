...
/// <summary>
/// Represents a request to create an exact-change review receipt for the current transaction.
/// </summary>
internal sealed record TransactionReviewRequest : WorkspaceMutationRequest
{
