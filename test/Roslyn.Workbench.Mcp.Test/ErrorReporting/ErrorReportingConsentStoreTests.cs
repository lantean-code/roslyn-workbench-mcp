...
public sealed class ErrorReportingConsentStoreTests
{
    [Fact]
    ...
    private static ErrorReportingConsentStore CreateTarget(ErrorReportingConsentMode mode)
    {
        ...
        return new ErrorReportingConsentStore(Options.Create(options));
    }
}
