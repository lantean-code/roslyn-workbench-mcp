...
internal sealed class IntroduceVariableTool : CodeActionMutationToolHandler<IntroduceVariableRequest>
{
    ...
    protected override ValueTask<CodeActionExecutionResult<WorkspaceMutationProposal>> ExecuteCoreAsync(IntroduceVariableRequest request, ICodeActionMutationContext context, CancellationToken cancellationToken)
    {
