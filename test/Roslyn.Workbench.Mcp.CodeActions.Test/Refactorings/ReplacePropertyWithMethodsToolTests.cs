...
public sealed class ReplacePropertyWithMethodsToolTests
{
    [Fact]
    public async Task GIVEN_LocationRequest_WHEN_CallingExecuteAsync_THEN_ShouldStagePropertyReplacementAction()
    {
        ...
        var target = new ReplacePropertyWithMethodsTool(selectionStager.Object);
